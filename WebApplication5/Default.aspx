        ...
        <div class="col-md-4">
            ...
            <p>
                <asp:UpdatePanel ID="upd" runat="server">
                    <ContentTemplate>
                   <asp:TextBox ID="txt1" runat="server" Text="0" AutoPostBack="true"  OnTextChanged="txt1_TextChanged1" ></asp:TextBox>
                <asp:HiddenField ID="hdot" runat="server" OnValueChanged="hdot_ValueChanged" />
